...
module.exports = {
  ...
  quote: (size) => {
    return (
      <div
        style={{ width: size + 'px', height: size + 'px', paddingTop: '1px' }}
      >
        <svg viewBox="0 0 512 512">
          <path
            fill="currentColor"
  ...
  ring: (size) => {
    return (
      <div
        style={{ width: size + 'px', height: size + 'px', paddingTop: '3px' }}
      >
        <svg viewBox="0 0 512 512">
          <path
            fill="currentColor"
  ...
  octicon: (name, settings) => (
    <Octicon icon={getIconByName(name)} height={settings.height} />
  ),
}
