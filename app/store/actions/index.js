...
export const updateBadge = (u, type, version) =>
  u('view.badge', (_) => ({ type, version }))
...
export const nodeProvider = (u, connected) =>
  u('node.provider', (_) => connected)
export const setCurrent = (u, id) => u('view.current', (_) => id)
export const updateUrl = (u, id, url) => u('view.data', id, 'url', () => url)
export const updateTitle = (u, id, title) =>
  u('view.data', id, 'title', (_) => title)
...
export const initialSignerPos = (u, pos) =>
  u('selected.position.initial', (_) => pos)
export const initialScrollPos = (u, pos) =>
