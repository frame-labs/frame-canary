            ...
            <div className="footerModule">
              <div className="requestApprove">
                <div
                  ...
                  style={{
                    pointerEvents: this.state.allowInput ? 'auto' : 'none',
                  }}
                  onClick={() => {
                    if (this.state.allowInput)
                      link.send('tray:giveAccess', req, false)
                  }}
                >
                ...
                <div
                  ...
                  onClick={() => {
                    if (this.state.allowInput)
                      link.send('tray:giveAccess', req, true)
                  }}
                >
            ...
            <div className="footerModule">
              <div className="requestApprove">
                <div
                  ...
                  onClick={() => {
                    if (this.state.allowInput) this.decline(req.handlerId, req)
                  }}
                >
                  <div className="requestDeclineButton _txButton _txButtonBad">
                    <span>Decline</span>
          ...
          return req.type === 'switchChain' ? (
            <div className="requestApprove">
              <div
                ...
                onClick={() => {
                  if (this.state.allowInput)
                    link.send('tray:switchChain', false, false, req)
                }}
              >
                <div className="requestDeclineButton _txButton _txButtonBad">
                  <span>Decline</span>
                ...
                onClick={() => {
                  if (this.state.allowInput) {
                    ...
                    link.send('tray:action', 'navDash', {
                      view: 'notify',
                      data: { notify: 'addChain', notifyData: { chain } },
                    })
                  }
                }}
              >
            ...
            <div className="footerModule">
              <div className="requestApprove">
                <div
                  ...
                  onClick={() => {
                    if (this.state.allowInput)
                      link.send('tray:addToken', false, this.props.req)
                  }}
                >
                  <div className="requestDeclineButton _txButton _txButtonBad">
                    <span>Decline</span>
