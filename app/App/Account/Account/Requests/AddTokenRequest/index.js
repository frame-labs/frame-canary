...
class AddTokenRequest extends React.Component {
  ...
  render() {
    ...
    if (originName.length > 28)
      originClass = 'requestTokenOrigin requestTokenOrigin18'
    if (originName.length > 36)
      originClass = 'requestTokenOrigin requestTokenOrigin12'
            ...
            <div className="approveTransactionPayload">
              ...
              <div className="requestToken scaleIn">
                <div className="requestTokenInner">
                  ...
                  <div className={'requestTokenOriginSub'}>
                    {'wants to add a token'}
                  </div>
                  <div className="requestTokenInfo">
                    <div className="requestTokenSymbol">
