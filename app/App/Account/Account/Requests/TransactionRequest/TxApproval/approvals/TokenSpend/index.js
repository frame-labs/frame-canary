...
class TokenSpend extends React.Component {
  constructor(...args) {
    ...
    this.requestedAmount =
      '0x' + new BigNumber(data.amount).integerValue().toString(16)
    this.state = {
      inPreview: false,
  ...
  render() {
    ...
    const displayInt = new BigNumber(this.state.amount)
              ...
              {this.state.exiting ? (
                <div className="approveTokenSpendConfirm">
                  {displayAmount.number ? (
                    <div className="approveTokenSpendConfirmNumber">
                      {displayAmount.number}
                    </div>
                  ) : null}
                  {displayAmount.symbol ? (
                    <div className="approveTokenSpendConfirmNumberText">
                      {displayAmount.symbol}
                    </div>
                  ) : null}
                  <div className="approveTokenSpendConfirmSymbol">
                    {data.symbol}
                  </div>
                </div>
              ) : (
                <div className="approveTokenSpendEdit">
                  ...
                  <div className="approveTokenSpendPresets">
                    ...
                    >
                      <span className="approveTokenSpendPresetButtonInfinity">
                        {'Unlimited'}
                      </span>
                    </div>
                    {!inputLock ? (
                ...
                {data.spender ? (
                  <div className="approveTokenSpendSpenderAddress">
                    <div className="approveTokenSpendSpenderAddressLarge">
                      ...
                      {data.spender.substr(
                        data.contract.length - ADDRESS_DISPLAY_CHARS,
                      )}
                    </div>
                    <div
