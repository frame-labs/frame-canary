...
class TxFee extends React.Component {
  ...
  render() {
    ...
    const minFeePerGas = maxFeePerGas
      .dividedBy(reduceFactor)
      .dividedBy(reduceFactor)
        ...
        <div className="_txMainInner">
          ...
          <div className="_txMainValues">
              ...
              <div className="_txMainValuesColumn" style={{ flex: '1' }}>
                ...
                >
                  <div className="_txFeeGwei">
                    <span className="_txFeeGweiValue">
                      {this.toDisplayGwei(maxFeePerGas)}
                    </span>
                ...
                {this.toDisplayUSD(maxFeeUSD) !== '0.00' ? (
                  <div className="_txMainTag">
                    ...
                    >
                      ...
                      <span className="">{`in ${currentSymbol || '?'}`}</span>
                    </div>
                  </div>
                ) : null}
              </div>
            ...
            {req.feesUpdatedByUser ? (
              <div className="_txMainTag">{`Gas values set by user`}</div>
