          ...
          <div className="transactionDataBodyInner">
            ...
            {req.decodedData ? (
              <div className="decodedDataContract">
                <div className="decodedDataContractArgHeader">
                  Contract Method
                </div>
                ...
                {req.decodedData.args.map((a) => {
                  return (
                    <div key={a.name} className="decodedDataContractArg">
                      ...
                      <div className="decodedDataSubtitle">
                        {a.name + ' (' + a.type + ')'}
                      </div>
                    </div>
                  )
            ...
            <div className="txDataOverlayRaw">
              <div className="txDataOverlayRawTitle">
                {'Raw Transaction Data'}
              </div>
              <div
                className="txDataOverlayRawData"
                onClick={() => this.copyData(req.data.data)}
              >
