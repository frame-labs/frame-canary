...
describe('#deriveAddresses', () => {
  it('derives legacy addresses', async () => {
    ...
    expect(addresses[0].toLowerCase()).toBe(
      '0x46bdba9c90ea453426d0b8d4a7a8a99b8a9dade5',
    )
  }, 200)
  ...
  it('derives standard addresses', async () => {
    ...
    expect(addresses.length).toBe(100)
    expect(addresses[5].toLowerCase()).toBe(
      '0xe001da2733a5dc2ce5191de0534282683f05f0b8',
    )
  }, 200)
  ...
  it('derives testnet addresses', async () => {
    ...
    expect(addresses.length).toBe(100)
    expect(addresses[3].toLowerCase()).toBe(
      '0xaffb4ca2ed8738dd409b7563052b3e7c7bdaabdb',
    )
  }, 200)
...
describe('#signMessage', () => {
  it('signs a message with a hex prefix', async () => {
    ...
    const ethApp = await createEthApp(replayData)
    const signature = await ethApp.signMessage(
      "44'/60'/0'/0/2",
      '0x68656c6c6f2c204672616d6521',
    )
