...
describe('#getFeePerGas', () => {
  ...
  it('calculates the priority fee for the next block based on normal blocks', async () => {
    ...
    gasUsedRatios = [
      0.12024061496050893, 0.17942918604838942, 0.23114498292513627,
      0.1801134637893198,
    ]
    blockRewards = [
      ['0xee6b2800'],
  ...
  it('excludes full blocks from the priority fee calculation', async () => {
    ...
    gasUsedRatios = [
      0.91024061496050893, 0.17942918604838942, 0.23114498292513627, 1,
      0.1801134637893198,
    ]
    blockRewards = [
      ['0xee6b2800'],
  ...
  it('excludes "empty" blocks from the priority fee calculation', async () => {
    ...
    gasUsedRatios = [
      0.01024061496050893, 0.17942918604838942, 0.23114498292513627,
      0.0801134637893198, 0.1801134637893198,
    ]
    blockRewards = [
      ['0xee6b2800'],
      ['0x3b9aca00'],
  ...
  it('uses a default priority fee of zero gwei when no eligible blocks are available', async () => {
    gasUsedRatios = [
      0.01024061496050893, 0.07942918604838942, 1.23114498292513627,
      0.0801134637893198, 1.1801134637893198,
    ]
    blockRewards = [
      ['0xee6b2800'],
      ['0x3b9aca00'],
