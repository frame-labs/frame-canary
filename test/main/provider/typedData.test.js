...
describe('#getVersionFromTypedData', () => {
  ...
  const validRequests = [
    ...
    {
      data: typedDataInvalid,
      version: 'V4',
      dataDescription: 'eip-712 invalid',
    },
    {
      data: typedDataRecursive,
      version: 'V4',
      dataDescription: 'eip-712 with recursion',
    }, // supported by both v3 and v4
    {
      data: typedDataArrays,
      version: 'V4',
      dataDescription: 'eip-712 with arrays',
    }, // unsupported by v3
    {
