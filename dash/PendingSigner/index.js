...
class Pending extends React.Component {
  ...
  render() {
    ...
    if (this.props.type === 'trezor' && this.props.status === 'Need Pin')
      style.height = '300px'
    if (
      this.props.type === 'trezor' &&
      this.props.status === 'Enter Passphrase'
    )
      style.height = '180px'
        ...
        <div className="pendingSignerInset">
          <div className="pendingSignerTop">
            ...
            <div className="pendingSignerText">
              <div className="pendingSignerType">
          ...
          <div className="signerInterface">
            {this.renderTrezorPin(
              this.props.type === 'trezor' && this.props.status === 'Need Pin',
            )}
