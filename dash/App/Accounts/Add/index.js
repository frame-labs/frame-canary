...
class Add extends React.Component {
  ...
  componentDidMount() {
    ...
    this.particleWorker.postMessage({ type: 'init', canvas: this.canvas }, [
      this.canvas,
    ])
  }
              ...
              {state !== 'exited' ? (
                <>
                  ...
                  <div
                    className={
                      state === 'entered'
                        ? 'addAccountMain addAccountMainActive'
                        : 'addAccountMain'
                    }
                  >
                    <div className="addAccountMainInner">
                      ...
                      <div className="addAccountSubtitle">
                        Add or create a decentralized account to use with any
                        dapp
                      </div>
                      <div className="addAccountBreak" />
