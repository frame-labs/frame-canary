...
class Notify extends React.Component {
          ...
          <div className="notifyBox">
            ...
            <div className="notifyBody">
              ...
              <div className="notifyBodyBlock">
                Be advised, this version of Frame is currently in "beta" and
                will update on a beta track
              </div>
              <div className="notifyBodyBlock">
                Use hardware signers for high value accounts and verify all
                transaction and account details on your signing device
              </div>
              <div className="notifyBodyBlock">
                <span>Read</span>
                <span
  ...
  render() {
    ...
    if (notify === 'mainnet') {
      ...
      return (
        <div className="notify cardShow">{this.gasFeeWarning(notifyData)}</div>
      )
      ...
      return (
        <div className="notify cardShow">{this.openExternal(notifyData)}</div>
      )
    } else if (notify === 'openExplorer') {
      return (
        <div className="notify cardShow">{this.openExplorer(notifyData)}</div>
      )
