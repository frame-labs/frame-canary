            ...
            <div className="chainConfig cardShow">
              ...
              <div className="chainConfigRow">
                <input
                  ...
                  onBlur={(e) => {
                    if (e.target.value === '')
                      this.setState({ explorer: this.props.explorer })
                  }}
                />
              </div>
            </div>
              ...
              <div className="chainMore cardShow">
                <div
                  ...
                  onMouseDown={() => {
                    ...
                    link.send('tray:action', 'removeNetwork', {
                      id,
                      name,
                      explorer,
                      type,
...
class _ChainModule extends React.Component {
  ...
  status(type, id, layer) {
    ...
    if (current === 'custom') {
      if (
        ...
        if (!this.okProtocol(this.state.primaryCustom))
      ...
      if (
        ...
        if (!this.okProtocol(this.state.secondaryCustom))
          status = 'invalid target'
        else if (!this.okPort(this.state.secondaryCustom))
          status = 'invalid port'
      }
    }
  ...
  render() {
    ...
    presets = Object.keys(presets).map((i) => ({
      text: i,
      value: type + ':' + id + ':' + i,
    }))
                  ...
                  <>
                    <div className="connectionOptionDetails cardShow">
                      <div className="connectionOptionDetailsInset">
                        ...
                        <Dropdown
                          syncValue={
                            type + ':' + id + ':' + connection.primary.current
                          }
                          onChange={(preset) => {
                    ...
                    <div
                      className={
                        connection.primary.current === 'custom' &&
                        connection.primary.on
                  ...
                  <>
                    <div className="connectionOptionDetails cardShow">
                      <div className="connectionOptionDetailsInset">
                        ...
                        <Dropdown
                          syncValue={
                            type + ':' + id + ':' + connection.secondary.current
                          }
                          onChange={(preset) => {
                            const [type, id, value] = preset.split(':')
                            link.send(
                    ...
                    <div
                      className={
                        connection.secondary.current === 'custom' &&
                        connection.secondary.on
                          ? 'connectionCustomInput connectionCustomInputOn cardShow'
                          : 'connectionCustomInput'
                      }
...
class _Network extends React.Component {
  ...
  customSecondaryFocus() {
    if (this.state.secondaryCustom === this.customMessage)
      this.setState({ secondaryCustom: '' })
  }

  customSecondaryBlur() {
    if (this.state.secondaryCustom === '')
      this.setState({ secondaryCustom: this.customMessage })
  }

  customPrimaryFocus() {
    if (this.state.primaryCustom === this.customMessage)
      this.setState({ primaryCustom: '' })
  }

  customPrimaryBlur() {
    if (this.state.primaryCustom === '')
      this.setState({ primaryCustom: this.customMessage })
  }
  ...
  render() {
    ...
    const { id, name, type, explorer, symbol, layer, connection, filter } =
      this.props
          ...
          <div
            ...
            onClick={() => {
              ...
              link.send('tray:action', 'navDash', {
                view: 'notify',
                data: { notify: 'updateChain', notifyData: { chain } },
              })
            }}
          >
            {svg.gear(11)}
          ...
          <div className="chainModules">
            ...
            <div className="chainFooter">
              <div className="chainCurrencyItem">
                ...
                <div className="sliceChainIdNumber">
  ...
  quit() {
    return (
      <div className="quitFrame">
        <div
          onMouseDown={() => link.send('tray:quit')}
          className="quitFrameButton"
        >
          Quit
        </div>
      </div>
