...
class Settings extends React.Component {
  constructor(props, context) {
    ...
    const latticeEndpointMode = context.store(
      'main.latticeSettings.endpointMode',
    )
    this.state = {
      localShake: {},
      latticeEndpoint,
  ...
  quit() {
    return (
      <div
        className="addCustomTokenButtonWrap quitFrame"
        style={{ zIndex: 215 }}
      >
        <div
          className="addCustomTokenButton"
  ...
  expandNetwork(e, expand) {
    e.stopPropagation()
    this.setState({
      expandNetwork: expand !== undefined ? expand : !this.state.expandNetwork,
    })
  }
            ...
            onClick={() =>
              link.send('tray:action', 'navDash', {
                ...
                data: {
                  notify: 'openExternal',
                  notifyData: {
                    url: 'https://github.com/floating/frame/blob/master/LICENSE',
                  },
                },
              })
            }
